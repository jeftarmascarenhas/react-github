...
const Logo = ({ className, alt }) => (
  <svg version="1.1" className={className} id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 width="612px" height="612px" viewBox="0 0 612 612" style={{'enable-background':'new 0 0 612 612', fill: '#ffe255'}}>
    <g>
      <g>
